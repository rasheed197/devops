...
All these options are WINDOWS FEARTURES. Just search "windows features" in the search bar
- Microsoft Hyperv
...
- Under "Create Virtual Hard Disk..."
    - Make sure to unlock "Pre-allocate Full Size"
...
- To see your computers network adapter adapter and its IP address
```
# Windows
ipconfig
