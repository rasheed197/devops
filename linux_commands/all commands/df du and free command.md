...
available:      An estimate of how much memory is available for new applications without needing to swap. 
                This includes both truly free memory and reclaimable buff/cache.
```
