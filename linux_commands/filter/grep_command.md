...
-v              To print nonmatching (rather than 
                matching) lines.

-n              Display the line containing the pattern 
                along with their line number

-c              To print a count of matching lines

-l              Makes grep print only the names of 
                matching files rather than printing each  
                line that matches. 
                
-r              Search through all files in a directory 
