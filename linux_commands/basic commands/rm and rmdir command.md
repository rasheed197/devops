...
```
### Example 4
Remove a non-empty directory and its contents (subdirectories and files). recursively
...
### Example 5
Forces deletion without asking for confirmation, even if files are write-protected, and ignores non-existent files.
```
$ rm -f file_name
